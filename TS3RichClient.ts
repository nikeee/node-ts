...
export class TS3RichClient
{
    ...
    {
        this._client = new ts3.TeamSpeakClient(host, port);
    }

    /**
     * Authenticates with the TeamSpeak 3 Server instance using given ServerQuery login credentials.
     */
    public login(username: string, password: string): Q.Promise<ts3.CallbackData<ts3.GenericResponseData>>
    {
        return this._client.send("login", {
     ...
     */
    public logout(): Q.Promise<ts3.CallbackData<ts3.GenericResponseData>>
    {
        return this._client.send("logout");
    }

    /**
     * Closes the ServerQuery connection to the TeamSpeak 3 Server instance.
     */
    public quit(): Q.Promise<ts3.CallbackData<ts3.GenericResponseData>>
    {
        return this._client.send("quit", {}, []);
    }
     ...
     */
    public banclient(clid: number, time: number= 0, banreason: string = ""): Q.Promise<ts3.CallbackData<ts3.GenericResponseData>>
    {
        /*
            clid: number;
            time?: number;
     ...
     */
    public bandelall(): Q.Promise<ts3.CallbackData<ts3.GenericResponseData>>
    {
        return this._client.send("bandelall");
    }
     ...
     */
    public banlist(): Q.Promise<ts3.CallbackData<ts3.BanListResponseData>>
    {
        return this._client.send("banlist");
    }
